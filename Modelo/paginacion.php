...
Class Paginacion{
  ...
  function mostrar_resultados($nom_tabla,$pagina){
    ...
    function mostrar_links(){
        ...
        //     $links[]="<a href='../Vista/formulario_blog.php?enlace=si&&tam=" . $this->tam_paginas . "&&pag=" . $i . "'>" . $i . "</a>";         
        $links[] = "<a href='../Controlador/transacciones.php?enlace=si&&tam=". $this->tam_pagina . "&&pag=" . $i . "&&titulo=" . $titulo ."'>".$i."</a>";
